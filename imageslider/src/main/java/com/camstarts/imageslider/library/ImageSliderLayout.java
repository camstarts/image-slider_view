...
/**
 * SliderLayout is compound layout. This is combined with {@link com.camstarts.imageslider.library.indicators.PagerIndicator}
 * and {@link com.camstarts.imageslider.library.tricks.ViewPagerEx} .
 *
...
public class ImageSliderLayout extends RelativeLayout{
    ...
    public ImageSliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs,R.styleable.ImageSliderLayout,
                defStyle,0);

        mTransformerSpan = attributes.getInteger(R.styleable.ImageSliderLayout_pager_animation_span, 1100);
        mTransformerId = attributes.getInt(R.styleable.ImageSliderLayout_pager_animation, Transformer.Default.ordinal());
        mAutoCycle = attributes.getBoolean(R.styleable.ImageSliderLayout_auto_cycle,true);
        int visibility = attributes.getInt(R.styleable.ImageSliderLayout_indicator_visibility,0);
