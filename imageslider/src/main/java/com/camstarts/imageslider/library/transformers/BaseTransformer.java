 ...
 *
 * BaseTransformer implement {@link com.camstarts.imageslider.library.tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.camstarts.imageslider.library.tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.camstarts.imageslider.library.animations.BaseAnimationInterface}
 * work.
 *
