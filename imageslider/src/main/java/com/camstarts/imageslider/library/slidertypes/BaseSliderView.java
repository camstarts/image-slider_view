...
public abstract class BaseSliderView {
    ...
    protected OnImageSliderClickListener mOnImageSliderClickListener;
     ...
     * @return
     */
    public BaseSliderView setOnSliderClickListener(OnImageSliderClickListener l){
        mOnImageSliderClickListener = l;
        return this;
    }
    ...
    protected void bindEventAndShow(final View v, ImageView targetImageView){
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            if(mOnImageSliderClickListener != null){
                mOnImageSliderClickListener.onSliderClick(me);
            }
            }
        });
